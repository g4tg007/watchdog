...
# wvs安装位置
wvs_location = 'D:/sec_tools/Web Vulnerability Scanner 10/'

# 扫描结果存储位置
wvs_save_dir = 'D:/work/618/wvs_result/'

# WVS扫描语句，具体可在http://www.acunetix.com/blog/docs/acunetix-wvs-cli-operation/ 查询
wvs_scan_sentence = '/Scan "%s" /Profile 618 /ExportXML /SaveFolder %s  --RestrictToBaseFolder=true'
